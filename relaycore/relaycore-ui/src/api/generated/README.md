...
var api = new OpenApiDefinition.RelayEngineApi()
...
------------ | ------------- | ------------- | -------------
*OpenApiDefinition.RelayEngineApi* | [**handle**](docs/RelayEngineApi.md#handle) | **POST** /api/v1/relay | Ingest a new webhook
